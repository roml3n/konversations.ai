...
export default function Button({
  ...
  const variantClasses: Record<ButtonVariant, string> = {
    ...
    secondary:
      "outline-white inline-flex justify-center items-center outline outline-1 outline-offset-[-1px] rounded-full text-base font-semibold  text-white outline-offset-[-1px] px-3 py-2 -md:px-4 md:py-3 lg:px-7 lg:py-4 -md:text-base lg:text-lg ",
  };
